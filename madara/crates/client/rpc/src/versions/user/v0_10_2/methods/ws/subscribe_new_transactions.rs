...
/// Streams received, candidate, preconfirmed, and confirmed transactions matching the requested filters.
...
async fn send_transaction_item(
    ...
    super::send_starknet_subscription(sink, super::NEW_TRANSACTION_NOTIFICATION_METHOD, &item).await
}
